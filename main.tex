...
The document in question corresponds to 1:22:30~a.m. The AZ button was pressed at 1:23:40~a.m. Between these times lies scarcely a minute -- supposedly sufficient for a complete analysis of the positions of 211~control rods. Could anyone have accomplished such a task? The Soviet informants clearly sought to cast blame upon the operators; but why did the IAEA experts not pause to reflect?

A logical contradiction follows. They write: \textit{"The reactor did not have sufficient reactivity margin to meet shutdown requirements. At that time, the operator should have shut down the reactor."} It is the equivalent of the phrase \textit{"Execute not pardon"} -- without punctuation\footnote{Catherine the Great once issued a resolution on condemned criminal's request for pardon which said literally \textit{"Execute Not Pardon."} Lack of punctuation made it unclear whether the empress wanted execution (Execute, [Do] Not Pardon) or pardon (Execute Not, Pardon).}. Suppose that we had indeed noted a diminished margin: according to the Operating Regulations, upon any deviation of parameters, the protective system must be engaged -- and that is precisely what we did. We pressed the protection button, and the explosion ensued.
...
The Program set a power range of 700 to 1,000~MW. Immediately before its execution the reactor stood at 200~MW. The cause of that reduction will be explained later. We threw a bone in the mouths of our accusers they still gnaw on. Even the Soviet informants to the IAEA let themselves be misled: eager to discredit the staff, they, Legasov at their head, declared to the world that operation below 700~MW was forbidden by the Operating Regulations.
