...
I never comprehended the logic of these \textit{``motivational injections.''} They produced only harm. When deadlines are impossible, conscientious men still make the attempt at first; later all acknowledge the futility, and the indolent take it as licence for idleness. I observed this many times. Such campaigns were no more useful than the perennial slogan: \textit{``We shall give all our strength to commission Unit No.~\_\_ by \_\_ date.''} A rational man may well smile: \textit{All my strength? And thereafter -- what remains?}\footnote{Lit. \textit{``Вообще, полагаю, монтажники неподвластны СПИДу.''} -- \textit{``In general, I believe that installation workers are not subject to AIDS.''} A pun on the Russian acronym СПИД (\textit{S.P.I.D.}), which stands for \textit{``Синдром приобретённого иммунного дефицита''} -- Acquired Immunodeficiency Syndrome (AIDS). In Russian, the word \textit{``подвластный''} means \textit{``subject to''} or \textit{``under the power of.''} Dyatlov plays on the double meaning of \textit{``подвластны СПИДу''} -- \textit{``subject to AIDS''} and \textit{``under the power of motivational campaigns.''}}
...
At 00:43~a.m., the reactor emergency shutdown signal -- triggered by the stop of both turbogenerators -- was blocked. A little earlier, the Emergency Protection setpoint for the turbine-trip signal on pressure drop in the drum separators had been reduced from 55~atmospheres to 50.
...
\begin{personal}[From A.~A.~Yadrikhinsky:]
\textit{``The critical error of the operating personnel in the Chernobyl accident is the pressing of the AZ-5 button (a correct operational action) while operating the reactor with a reactivity margin of less than 15 rods.''}
\end{personal}
...
The reactor possessed a positive prompt power coefficient of reactivity, rendering it dynamically unstable. The positive reactivity effect upon dehydration of the coolant circuit amounted to $5$--$6\,\beta$. Post-accident calculations demonstrate that the reactor would explode in a broad array of scenarios.
...
Is it possible, at the present stage, to dispense with nuclear power? Yes, it is possible. Will it be better? I am far from certain. Advocates of nuclear power assert that it is indispensable. But why? In 1990 the nuclear power plants of the Soviet Union generated 211~billion~kWh of electricity. To produce the same amount at thermal power stations would have required 50-60~million~tons of coal. With a national output of 700~million tons of coal, such a quantity does not seem unattainable. Nor would the additional burden upon the environment be great, if one considers all forms of fuel consumption. And burning fuel in properly designed thermal plants does far less harm than its combustion in primitive boilers and household stoves. Yes and no.
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}]
\textit{``The officer and soldiers are not wearing respirators; they hang on their necks. Illiteracy from poorly organized training\ldots After all, future generations will come from these young men. Even 1~R/hour gives a 50\% probability of mutation\ldots''}
\end{personal}
...
\textit{``According to the UN Scientific Committee on the Effects of Atomic Radiation, with the participation of the world's leading specialists in radiation genetics, it has been established that doubling the mutation rate under acute irradiation occurs upon exposure to 30~R. If a person is subjected to chronic small doses over the reproductive period (30~years), then the total dose capable of doubling the mutation rate amounts to 100~R.}

\textit{Any increase in radiation entails some degree of hereditary damage in humans corresponding to the dose received.''}
\end{personal}

Pay no heed to the differing units -- roentgen, rad, rem: for $\gamma$- and $\beta$-radiation they may be treated as equal. Thus, according to the UN committee, a single dose of 30~R or a chronic dose of 100~R can double the mutation rate over the natural background. Given that the natural background already yields roughly 70 congenital defects per 1000 newborns, even doubling the dose does not produce anything like a 50\% mutation rate.
...
Let us suppose we violated the Regulations by disabling the ECCS. But what has that to do with the explosion? The emergency core cooling system could not possibly have prevented the explosion of the reactor, and after the explosion it was useless, for the reactor had ceased to exist. Only the ``great operational expert'' G.~Medvedev asserts that it could, by some mystical means, have averted the explosion, and the ``naive'' academician A.~P.~Aleksandrov professed horror at its disconnection. Even the official commissions -- who certainly would not have overlooked such an opportunity -- never suggested that the ECCS could have prevented the accident. Had there been even a ghost of such a possibility, they would undoubtedly have pressed it.
...
\textit{Translator's note:} This chapter was not originally published in Russian or with \textit{``How It Was''}, although it circulates in many editions of the book.
...
\begin{itemize}
\item A $10\%$ decrease in flow over 36~s of coast-down produces a reactivity increase easily compensated by the Automatic Regulator system. No power increase occurred.
...
During coast-down the coolant density changed by $6~\text{kg/m}^3$ (Table~2, Appendix), yielding a reactivity increase of roughly $24\times10^{-6}$. Under actual conditions the rate of reactivity change is often several times greater.
...
\textit{``The second-generation RBMK units were initially loaded with 2\% enriched fuel, but even with this enrichment, as burnup increased to 1100-1200~MWd/t and with the regulatory operational margin of 26-30 rods, the steam-void coefficient approached $+5\beta_{\mathrm{eff}}$. Similar burnup existed at Unit~4 before the accident.''}
\end{personal}

At such a steam-void coefficient the power coefficient reaches $+0.6\beta_{\mathrm{eff}}/\mathrm{MW}$ above 50\% power. At lower power it is even more positive.

\subparagraph{4.2.\ As N.~Laletin noted}
For a uniformly burnt-out core the steam-void effect is roughly twice as large as for a core with the same \textit{average} burnup but heterogeneous distribution. Thus the end of the transition period (with virtually all Additional Absorbers removed) is more dangerous than steady-state refuelling. Exactly such a state existed at Unit~4: 1~additional absorber, 1~empty channel, and 1659 assemblies with average burnup 1180~MWd/t; 75\% of them first-load assemblies burnt to 1150-1700~MWd/t.

The steam-void effect exceeded $+5\beta_{\mathrm{eff}}$, and that alone sufficed for an explosion.
...
\subparagraph{5.3.\ Report, §5.2.1:} \textit{``It had been asserted that prolonged operation of the reactor below 700~MW was prohibited. This assertion was based on incorrect information. Such a prohibition ought to have existed, but at the time it did not.''}

That reactor could ``successfully'' explode even at 700~MW. There existed \textit{no} safe power level -- merely levels more or less perilous. By contrast, a reactor conforming to design rules requires no such artificial limitation.

No technical justification existed for 700~MW as a ``safe'' value. That figure acquired an almost mystical authority solely to create an appearance of operator fault.  
...
After the unplanned power drop, the author limited the rise to 200~MW -- sufficient for the test -- not because 700~MW was unattainable. With a positive prompt power coefficient nothing prevents a rise in power. Moreover, 200~MW was an ordinary, regulation-permitted level.
...
After measures reducing the steam-void coefficient to $0.8\beta_{\mathrm{eff}}$, the power coefficient at 200~MW became $-6\text{-}10\times10^{-7}\beta_{\mathrm{eff}}/\mathrm{MW}$. What was it when the steam-void coefficient was $+5\beta_{\mathrm{eff}}$? And note: contrary to the experts' assertions, the danger increases as coolant flow \textit{decreases}.
...
\small\begin{center}
  \begin{longtable}{|p{6em}|p{27em}|}
    ...
    \hline
    01:06 a.m. & Start of unloading of the power unit; ORR equal to 31 control rods (RR). \\ \hline
    ...
    03:47 a.m. & Reactor thermal power 1600~MW. \\ \hline
    04:13:00 a.m. until 12:36:00 p.m. & Successive measurement of characteristics of the control systems and vibration characteristics of Turbogenerator-7 and Turbogenerator-8 at constant reactor thermal power of 1500~MW. \\ \hline
    07:10 a.m. & ORR equal to 13.2 RR rods. \\ \hline
    ...
    03:20 p.m. & ORR equal to 16.8 RR rods. \\ \hline
    ...
    11:10 p.m. & Power-unit unloading resumed; ORR equal to 26 RR rods. \\ \hline
    \multicolumn{2}{|c|}{\textit{26 April 1986 (times per the DREG printout, operating log marked OL)}} \\ \hline
    00:05 a.m. (OL) & Reactor thermal power reached 720~MW. \\ \hline
    00:28 a.m. (OL) & At reactor thermal power about 500~MW, transition from the local automatic power control system to main-range automatic power control (1AR, 2AR). During the transition an unprogrammed decrease of thermal power occurred down to 30~MW (neutron power to zero). Power rise initiated. \\ \hline
    00:34:03 a.m. & Emergency level deviations in the steam-drum separators. \\ \hline
    00:36:24 a.m. & AZ-5 setpoint for drop in pressure in the steam-drum separators shifted from 55 to 50~kgf/$\text{cm}^2$.\\ \hline
    ...
    01:03 a.m. (OL) & Reactor thermal power raised to 200~MW and stabilised. \\ \hline
    ...
    01:23:43 a.m. & AZ signals appear for reactor runaway period -- period less than 20~s; also power-limit signals -- power above 530~MW. \\ \hline
    ...
    01:23:47 a.m. & Sharp decrease (by 40\%) of flow in Main Circulation Pumps not involved in coastdown (MCP-11, MCP-12, MCP-21, MCP-22) and unreliable readings of Main Circulation Pump flow for Main Circulation Pumps involved in coastdown (MCP-13, MCP-14, MCP-23, MCP-24); sharp pressure rise in the steam-drum separators (SDS); sharp rise of level in SDS; signals ``malfunction of measuring part'' for both main-range Automatic Regulator systems (1AR, 2AR). \\ \hline
    01:23:48 a.m. & Restoration of Main Circulation Pump flow (non-coasting) to values close to initial; on coasting Main Circulation Pumps of the left side: restoration to 15\% below initial; on coasting Main Circulation Pumps of the right side: restoration to 10\% of initial for MCP-24 and unreliability for MCP-23; further pressure rise in SDS (left side 75.2~kgf/$\text{cm}^2$, right side 88.2~kgf/$\text{cm}^2$) and level rise; actuation of BRU-K1 and BRU-K2.\\ \hline
    01:23:49 a.m. & AZ signal ``pressure rise in RP (channel rupture)''; signal ``no 48~V supply'' (power removed from Control and Protection System rod servo-clutch coils); signals ``malfunction of actuator part of 1AR, 2AR''. From the operating log of the senior reactor control engineer: ``01:24 a.m.: Strong blows, Control and Protection System rods stopped before reaching the bottom limit switches. Power to the clutch coils removed.'' \\
    \hline
  \end{longtable}
\end{center}\normalsize
