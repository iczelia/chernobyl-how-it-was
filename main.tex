...
\usepackage{soul} % for \ul (line-breakable underline)
...
\DeclareSIUnit{\Year}{yr}  % capitalised to avoid clash with TeX primitive \year
...
The translation has been completed. Criticism of this translation, as well as any suggestions toward its improvement, will be gratefully received and may be addressed to \textit{k@iczelia.net}.
...
The configuration of these radioactive zones was determined alike by the nature of the emissions and the prevailing meteorological conditions. During the period of most violent release (26~April--5~May~1986), both the composition and the intensity of the radionuclides varied from day to day. In the first three days, under northerly winds, the radioactive clouds moved toward Belarus; by 30~April the wind had veered to the south and east, and the trace upon the ground shifted accordingly. The lighter radioactive gases and aerosols ascended into the higher atmosphere, where they circled the globe for months -- some for a year -- spreading throughout the Northern Hemisphere, before gradually settling, while the heavier particles, remaining in the lower strata of air, descended more swiftly to earth.

In the earliest weeks, the radiological environment was governed by short-lived isotopes, chief among them iodine-131. As these, and the medium-lived radionuclides after them, decayed, the hazard was assumed by nuclides of longer endurance -- cesium-137, strontium-90, and several isotopic forms of plutonium.

The consequences were most dire for the Republic of Belarus: 23~percent of its territory lay within the zone of contamination, embracing \num{3678}~inhabited~localities and about one-fifth of the population.

Within the European portion of the former USSR, the lands polluted by cesium-137 in excess of one curie per square kilometre comprised \num{3.2}~percent of the total area, while contamination exceeding \num{0.2}~curie extended over \num{23}~percent. In the Russian Federation, nineteen administrative regions were affected, most severely the Bryansk, Tula, Kaluga, Ryazan, and Penza districts, together containing some \num{2.3}~million inhabitants within the tainted zone.

Even fifteen years after the event, the causes of the accident and the measure of human responsibility remain the subjects of divergent judgment. Among the investigators, the scientist L.~A.~Ilyin, in his work \textit{Realities and Myths of Chernobyl} (p.~79), traced the sequence of occurrences that culminated in the disaster and ascribed the ultimate cause to defects inherent in the design of the RBMK reactor, particularly to its positive void -- or steam -- coefficient of reactivity.

\begin{flushright}\small{
-- V.V. Lomakin

\textit{Deputy Director for Safety Assessment, State Scientific and Technical Center for Nuclear and Radiation Safety (Kiev, Ukraine)}
}\end{flushright}
...
\begin{enumerate}
  \item There were no natural calamities -- no floods, no earthquakes, no impact of the Tunguska meteorite or any other.
...
This prompts a question: do these experts truly believe that a reactor -- constructed in full conformity with all regulatory standards -- can suffer an explosion (a nuclear explosion) solely through the fault of its operators? If so, their advocacy of nuclear power is ethically indefensible. Operators in the West, too, are liable to error.
...
All unit shift supervisors, and indeed the shop shift supervisors as well, had served at Chernobyl not less than five years. They were no mere administrative functionaries confined to desks, but were directly engaged in the conduct and supervision of the technological process.
...
Each fission of a uranium nucleus releases two to three neutrons, on average about two and a half. Their kinetic energy is absorbed by the moderator, the fuel, and the structural materials, and is thence transferred to the coolant. These neutrons sustain the chain reaction in uranium-235. If, on average, one neutron from each fission provokes one new fission, the rate of reaction remains constant.
...
Such a reactor cannot operate stably of itself, for fission produces a variety of secondary elements, among them xenon-135 in appreciable quantity, possessing an exceedingly large neutron-absorption cross-section. When the reactor power increases, xenon accumulates and may wholly suppress the chain reaction. This phenomenon first manifested itself in the earliest American reactor. Enrico Fermi, having computed the capture cross-section of xenon, remarked in jest that the nucleus appeared \textit{``as large as an orange.''}
...
The Soviet informants to the IAEA asserted that the disabling of the Emergency Core Cooling System\footnote{\textit{САОР}, typically referred to as ECCS in Western literature.} had deprived the plant of the means to mitigate the scale of the catastrophe. Without further comment, I cite a passage from the report of the N.~A.~Shteinberg Commission:
...
-- ``Well, all right then -- let's go,'' said the inspector.
\end{quote}
...
The Ministry of Energy, by contrast -- in 1981, when Chernobyl was already generating billions of kilowatt-hours -- did not possess even a serviceable minibus. I recall meeting Yugoslav specialists at Kiev airport in a wretched vehicle that rattled, leaked, and whistled with both northern and southern winds. A disgrace.
...
Before the handover I spoke with the outgoing shift supervisor, Yury~Tregub, and the incoming one, Aleksandr~Akimov. Only two tasks remained: measurement of turbine vibration in coasting mode (idle generator) and the execution of the experiment under the Turbogenerator Run-Down Test Program. No questions arose. Vibration measurement accompanies every maintenance shutdown -- nothing exceptional. Akimov had examined the preparations for the experiment the preceding day.
...
\item From the previous shift, Yury~Tregub and Sergei~Gazin, who remained to observe;
...
At 01:23:04~a.m., the monitoring system recorded the closure of the stop-valves feeding the turbine. The Turbogenerator Run-Down Experiment had commenced.
...
Hearing a brief exchange, I turned and saw the reactor operator, Leonid~Toptunov, speaking with Aleksandr~Akimov. I was about ten metres away and did not hear Toptunov's words. Akimov gave the command for shutdown and gestured -- press the button. He turned back toward the safety panel, which he was observing.
...
\textit{``The constant drive of reactor designers toward maximum economy is tied, in particular, to the need to remove from the core as many elements as possible that harmfully and parasitically absorb neutrons. Among others, one such element is water that remains in the lower part of a channel occupied by a power-control rod. To avoid this influence, a certain lower portion of the control rod -- of a strictly calculated size (emphasis mine -- A.D.) -- is made of non-absorbing material, thus displacing the corresponding amount of water in that channel, which previously had served, to an appropriate degree, as an absorber.''}
\end{personal}
...
\textit{``The number, location, efficiency, and insertion rate of the actuating mechanisms of the Emergency Protection System must be determined and analyzed in the reactor design documentation, where it must be shown that, under any emergency operating conditions and even with the most effective actuating mechanism assumed inoperable, the actuating mechanisms of the Emergency Protection System are able to guarantee that: in an emergency, the rate of reactor power reduction is high enough to prevent fuel-element damage from exceeding permissible limits; the reactor can be brought to a subcritical state and maintained in this state\ldots{}; no local critical masses are formed.''}
\end{personal}

The Control and Protection System rods not only failed to prevent such a local critical assembly -- they themselves created it at the bottom of the core. Deputy Director of NIKIET, I.~Ya.~Emelyanov, under whose direction the control-rod design was produced, testified during a lecture at the Baumanov School with cool pedantry: \textit{``Actuators that affect reactivity must be designed so that, while moving in one direction, the sign of the reactivity they introduce does not change.''} As though rods with the opposite property had not been created under his supervision.
...
\textit{``The reactor-plant signalling shall give alarms (visual and audible), including the emergency-alert siren, upon reaching Emergency Protection setpoints and upon emergency process deviations, and pre-alarms when approaching Emergency Protection thresholds, radiation rises above limits, or normal equipment function is impaired.''}
\end{personal}
...
What measuring tools existed will be noted shortly. If a deviation trips the unit without damage, well and good -- dock my bonus, issue a reprimand. But why must staff pay with life, health, and liberty for others' sins, and not the sinners themselves? I do not thirst for blood -- I myself served four years in the clink, and did not much care for it. But it frightens me that the people who designed an apparatus wholly unfit for operation still will not admit it, and, after a light shake-up, go on doing the same. What else will they yet gift to mankind?
...
\textit{``Protective systems must fulfil their safety functions even in the presence of failures independent of the initiating event, as defined in §1.2.4.''} Operator error, too, constitutes an initiating event.
\end{personal}
...
Here is an example of how a technically transparent and natural phenomenon may be distorted. As a result of prior actions of the Automatic Regulator, it remained with a negative imbalance (in fact, the reactor power stood below the set value) within the regulator's insensitivity range, as shown by the \textit{``PK up''} signal recorded by the diagnostic parameter program. When the generator coasted down, coolant flow diminished, which in turn increased reactivity, and the reactor power began to rise, entering the positive imbalance range, whereupon the regulator commenced downward motion. The \textit{``PK down''} signal was removed at 01:23:30~a.m.
...
Then all began. After a trifling dip in power at the very onset of rod motion -- unsurprising, since the axial flux was double-humped, with a top maximum and a mid-height depression, as after any power reduction, since during operation the flux maximum lay in the middle, where xenon poisoning is therefore greatest -- the rods' end-effect created a local supercritical region at the core's base; neutron flux and heat release surged there, while the upper region declined. The resultant reactivity from the rods became positive, and power increased chiefly in the lower part of the core.
...
Such signals must not appear while the Emergency Protection rods are descending -- with properly designed rods. Some now recall earlier cases when Emergency Protection had tripped on various signals (drum level, and others), and these same over-power indications flashed. Neither the operators nor the control-rod designers could explain them. How many such cases there were is hard to say, and perhaps now impossible to establish in full; operating staff have no wish to dig through the archives, and the governing bodies have even less need to. There is a further point: as a rule, once the primary cause of an AZ trip is known, the other alarm signals that appeared alongside it draw less attention -- even though the required explanatory notes called for every signal to be listed. They were judged spurious and ascribed to electronic malfunctions. We now see that they bore witness to faulty Emergency Protection behaviour.
...
Given people's ignorance of the actual circumstances, the accusers say that the staff knew of the violation, deliberately ignored the reading, and went on working. Suppose, then, that a 01:22:30~a.m. rod-position printout existed. It must be torn off, logged, carried fifty metres, and handed over. No one ran. At the start of the experiment, 01:23:04~a.m., no such printout could yet have been on the panel. Suppose it appeared a minute later, at 23:30, and the reactor operator or shift supervisor read it. Bad news. By the Regulations, one must then either bring the parameter back to normal (impossible) or trip AZ. The protection was tripped at 01:23:40~a.m. -- the explosion followed. But this last paragraph is written only to expose the plain bad faith of technically literate people who knew perfectly well both the unit and the circumstances. Such a printout, lacking the computer's calculated operational reactivity margin, conveyed nothing to the reactor operator; we never used raw position lists to gauge the margin -- we used the computed value.
...
Akimov informed the shift supervisor of the entire plant, B.~Rogozhkin, who in accordance with procedure notified both Moscow and Kiev. The station personnel are warned automatically by recorded telephone messages, according to the class of accident; in this case a \textit{General Accident} -- the most grave -- was declared. The manner in which the higher authorities were roused has been related elsewhere: by morning they were already arriving from Kiev and Moscow. Somewhere the plant's recording system failed, and the operator, to make certain, summoned staff by name from the list.
...
I further commanded that the turbine oil be drained into the emergency tanks and the hydrogen purged from the generators. All this was executed by the personnel of the Electrical and Turbine Departments. Executed -- and some died; some were grievously wounded. The deputies R.~I.~Davletbayev (Turbine Department) and A.~G.~Lelechenko (Electrical Department) rendered excellent assistance to the shift crews. A most extraordinary man, Aleksandr Grigorievich -- no large fellow, yet he somehow found strength, even after the twenty-sixth of April, to return for two or three days more into the same field of radiation. When at last they bore him to a hospital in Kiev, he did not live long.
...
Akimov, of course, took a larger dose, for he went into the plant rooms; V.~Babichev arrived about five o'clock. Even so, Babichev's dose too would have remained within two hundred rems.

Both remained and took part in pumping water toward the reactor. There they received their fatal exposure. Of anyone's ``guilt'' there was no word -- neither on the 26th nor in the first days thereafter, at least not in my hearing. Men sought only to understand \textit{why} it had happened; all discourse was upon that point. A.~P.~Kovalenko, chief of the Reactor Department, has said that he heard Akimov in the hospital murmur: ``Our chief mistake was pressing the emergency protection too late.'' Sasha was mistaken. That was not the cause. Nor was it the operating staff who committed the fatal errors. It is a grievous pity that the lads died under a false sense of guilt.
...
Rumour travels marvellously. Immediately upon leaving Chernobyl we passed through the village of Zalesskoye; women stood along the road, hands to their cheeks, pity in their eyes. There was a small incident: Viktor Smagin felt unwell, and the doctor was in another bus, so we had to stop. At once a crowd of women gathered about the bus, lamenting, gazing upon us in our hospital garb. Yes, our people are responsive and warm-hearted -- why, then, do they suffer both Chernobyl and all the other calamities that drive them to bitterness?
...
\textit{``The most probable cause of the explosion was boiling-up of the reactor core with rapid drying-out of the process channels as a result of a cavitation regime in the main circulation pumps (MCPs).''}
\end{personal}
...
\textit{The unit operated on the normal scheme with Turbine~8 in service, generating \qty{40}{\mega\watt} (electrical) at a reactor thermal power of about \qty{200}{\mega\watt}. Power was held by automatic control. All reactor parameters before the accident, up to pressing the AZ button, were normal and stable. No emergency alarms were recorded.}
...
\textit{According to VNIIAES calculations, the chief cause of the uncontrolled surge was AZ actuation under specific conditions: operating reactivity margin of eight rods and small inlet subcooling. The runaway resulted from the combined effect of:}
...
\item \textit{Pump operation at low power with high total flow (\qty{56000}{\meter\cubed\per\hour}) and small feedwater flow (not prohibited).}
...
\textit{An important circumstance is also that the Ministry of Power, for a long time, passively operated RBMK nuclear power plants whose cores had neutron-physical instability, paid no due attention to the frequent occurrence of AZM and AZS signals when Emergency Protection was actuated, and did not demand thorough analysis of accident situations\ldots One must acknowledge that an accident like Chernobyl's was inevitable.''}
\end{personal}
...
Did the staff invent the monstrous construction of the control rods? No. Then why are the staff, killed and maimed by this mastodon, to blame? For what, precisely, are Shift Supervisor Aleksandr Fyodorovich Akimov -- who ordered the emergency protection to be actuated when there were no emergency or even warning signals -- and Reactor Operator Leonid Fyodorovich Toptunov, who executed that order, supposed to be guilty? For nothing, of course. How can one accuse an operator who, whether from necessity or not, presses the AZ button? In any case -- given that AZ is now admitted to have blown up the reactor -- common human logic, as distinct from ``government'' logic, demands that all charges against the operator be withdrawn.
...
According to the new state policy, the USSR had embarked upon the path of \textit{glasnost} and openness. Therefore specialists headed by Scientist V.~A.~Legasov were sent to the International Atomic Energy Agency (IAEA) to inform ``the international community,'' as one of the informants, Dr.~A.~A.~Abagyan, expressed it.
...
There were no restrictions whatsoever upon the time for which the reactor might operate at powers \qtyrange[range-open-phrase={\text{from} }]{8}{3200}{\mega\watt}. There were no restrictions upon the maximum flow through the core, nor upon the connection of all eight pumps.
...
A rabid crew. In some matters incompetent, in the main tendentious, and in any case devoid of objectivity. Frankly, I would rather not speak of this commission at all. I beheld it at the most critical moments of my life, which I should be better off forgetting -- yet cannot. The representative of NIKIET, V.~Mikhan, appeared particularly \textit{``engaging''}: insolent and unscrupulous. Little better than he was L.~I.~Martynovchenko of Gosatomenergonadzor.
...
The acrobatic group act of these scientists could well be envied by the performers of the most celebrated circus. We already know in what manner violations of the Regulations were imputed to the staff. What remains is the parameter \textit{``reactivity margin.''} Just how \textit{``unpredictable''} is its violation -- or, more precisely, the staff's failure to notice its reduction? The conversation between the scientists and the operator might well have run thusly:
...
All the more because, apart from automatic protection upon reduction of the reactivity margin below \num{30}~rods, everything else has nothing whatsoever to do with the staff and ought to be implemented in accordance with general engineering rules.
...
Twice I addressed letters to \textit{Pravda}, and -- as the saying goes --received not so much as a word in return. I wrote where my words could be checked. But in our country one may freely smear people and then assume an air of innocence. Here they speak of \textit{``idiot-proofing,''} while Doctor of Physical and Mathematical Sciences O.~Kazachkovsky, again in \textit{Pravda} (15 October, 1989), says:
...
It is doubtful that in 1989 O.~Kazachkovsky did not know that the experiment and the accident were unrelated. In the same article he says:
...
\section{Scientist A.~P.~Aleksandrov}

Beyond question, he deserves separate consideration. In 1986 he was the President of the USSR Academy of Sciences, director of the Kurchatov Institute, Scientific Supervisor of the RBMK programme, the inventor of the RBMK reactor\footnote{Strictly speaking, the inventor of the RBMK was not A.~P.~Aleksandrov, but S.~M.~Feinberg.}. What other offices and dignities he then held I do not know; but in those I have named he stood in direct relation to the catastrophe of 26~April 1986.

It may be that I shall show myself biased toward him, for I am persuaded that it was precisely through the agency of Scientist A.~P.~Aleksandrov that I lost my health and became a convict. As inventor of the reactor and as Scientific Supervisor he did not ensure the necessary quality; as President, as director of the institute, as presiding officer at the sessions of the Interdepartmental Technical Council, he directed the investigation upon a false track. Even so, I shall not allow myself inventions: I shall set forth only the facts known to me, and my understanding of them.

Some twenty years ago, while still working in Komsomolsk-on-Amur, I came to the Kurchatov Institute on a business trip. Staff of the institute, E.~Alikin and others, told me that the director had a rule: any paper must first \textit{``lie a while,''} and if it roused scandalous notoriety, then it was needed and the time had come to give it course. I did not then imagine that this habit of A.~P.~Aleksandrov would roll like a heavy road-roller over the fates of many people, mine among them.

Apparently following that rule of his, A.~P.~Aleksandrov did not give progress to the proposals of the commission after the accident at Unit~1 of the Leningrad Nuclear Power Plant -- the proposals of V.~P.~Volkov and V.~L.~Ivanov. These proposals, and the decisions of the Scientific and Technical Council of the Ministry of Medium Machine Building to reduce the steam reactivity effect to \qty{1}{\beta}, lay, like others, under the blotter throughout the 1970s. Were they waiting for a \textit{``scandal''}? They got their wish\ldots
...
\textit{``In the IAE itself since 1965 there were employees I.~F.~Zhezherun, V.~P.~Volkov, and V.~L.~Ivanov, who pointed to the nuclear hazard of the proposed and subsequently implemented RBMK design. Their actions were successfully blocked by scientist A.~P.~Aleksandrov, and their memoranda were put `under the blotter'.}
...
Later, in operation, there were other manifestations of the reactor's unsatisfactory, dangerous qualities, of which A.~P.~Aleksandrov was informed.

% --

There can be no doubt that, knowing all this even before the catastrophe of 26~April, he clearly understood, once it had occurred, that the accident was, in pure form, the result of scientific and design miscalculations. And then, in order to save his own reputation (who would have judged him -- a thrice Hero of Socialist Labour, with eight Orders of Lenin?), he set in motion all levers to shift the blame exclusively onto the operating staff. This was not in the least difficult for him, since the investigation lay in the hands of the Ministry of Medium Machine Building, the Kurchatov Institute, and NIKIET. And such a conclusion poured balm into all hearts, up to the very top.

And mark with what tenacity the scientist defends his line! After five years there is not the slightest deviation. In the partisans he would have been priceless. In \textit{Ogonyok} no.~35 for 1990 his interview was printed -- highly characteristic. To the correspondent, A.~P.~Aleksandrov answers that he did not belong to the commission investigating the causes of the accident. Formally, yes: he is not the sort of scientist to thrust himself into affairs from which one may expect nothing but rebuffs. In fact he constantly followed and directed matters wherever he found it needful.

Further, his words:

\begin{personal}[From the Interview with A.~P.~Aleksandrov:]
...
A very characteristic pronouncement. It is astonishing how much falsehood can be packed into some twenty words. Let us sort out what is what.

First. The reactor \textit{``has shortcomings.''} No: it had impermissible defects, which excluded its operation -- direct violations of the regulatory documents adopted in the country. Of these the scientist does not speak; like the commissions, he stubbornly refuses to see those documents. In the text above I have shown how Emergency Protection was \textit{``coordinated''} with the requirements of the Rules. Here is how Professor B.~G.~Dubovsky, who until 1973 headed the nuclear safety service in the USSR, says in an abstract:
...
Moreover, A.~P.~Aleksandrov held the official post of Scientific Supervisor of the RBMK topic. What the reactor was at its inception, and what it remained thereafter up to the accident, is thus directly his contribution.

Third. A.~P.~Aleksandrov says that now these shortcomings have been reduced, compensated. That is correct. But he keeps silent that all these \textit{``shortcomings''} were known to him long before the Chernobyl accident. More on the scientist's selective memory below.

Fourth. The scientist lies by deception when he speaks of the car, the designer, and the driver. According to the objective testimony of the control system we pressed the AZ button in the absence of any emergency signals whatsoever. Were we entitled to expect a normal shutdown of the reactor? Without a doubt. The protection system is obliged to perform this even \textit{in the presence} of emergency signals -- that is what Emergency Protection is for. Actuation of reactor protection by the operator can in no way be regarded as a violation of nuclear safety. Therefore we did not \textit{``turn the steering wheel the wrong way.''} A more plausible comparison with a car would be this: \textit{``You are driving a car, you press the brake. Instead of braking, the car accelerates. An accident! Is the driver to blame? Or the designer, Citizen Academician?''}

True to his academic nature, A.~P.~Aleksandrov says:
...
The scientist's memory works in a strictly selective mode. He remembers the turbine, the valves; but as to the reactor -- though this lies squarely in the subject of the conversation -- A.~P.~Aleksandrov ``remembers'' no accident. His memory equally fails him when he speaks of the fleet, of submarines:
...
I, too, do not recall accidents on shipboard pressurised-water reactors due to manufacturing defects in the equipment prior to 1973. But on account of scientific support -- or rather, the lack of it -- to which the scientist stood in direct relation, there were such accidents.
...
What verve, what pathos! And yet all this is play for the gallery. The scientist knows perfectly well that removal of the ECCS did not in any way affect the occurrence of the accident. This is admitted by everyone, including his pupil V.~A.~Legasov, and even by the extremely tendentious judicial-technical commission. We disconnected the ECCS because, under the documents in force at that time, the chief engineer was permitted to do so, although one may agree that a categorical prohibition on removing the system would be proper, however small the probability that an MPA (Maximal Projected Accident - it was not an MPA on 26~April) would occur at that very moment.
...
And the Christian meekness of Scientist A.~P.~Aleksandrov -- \textit{``I am nobody's judge''} -- is a hypocritical posture that suits him no better than a sheepskin suits a wolf. What then is he doing in this interview? Making confession? That is not in evidence. As unjustly as he accused the staff before, so he continues. As they say, whichever way you fling him, he lands on his back. So it is with A.~P.~Aleksandrov: take whichever article; it is a lie. In an issue of \textit{Izvestiya} from 14~October 1989 we read:
...
And here again he throws it upon the period of stagnation, upon the \textit{``system.''} What has the period of stagnation to do with it? Who hindered him, who could have eliminated the impermissible defects of the reactor? Above all, the irresponsibility was his own. If there was irresponsibility, then it was far from universal. Proposals existed, and necessary ones, long before the accident. Over the RBMK reactor there was no one above A.~P.~Aleksandrov; all that he prescribed would have been carried out\footnote{A.~D.: Here I am mistaken in thinking that Aleksandrov could do absolutely everything: what I.~Ya.~Emelyanov did not wish to do, Aleksandrov could not compel.}. Another question is whether it is possible truly to manage when one holds a great many posts and positions.

The newspaper \textit{Pravda} slipped the scientist a bitter pill by printing his speech in the Central Committee at the mass retirement of elderly members. There he said:

\begin{personal}[From the Speech of A.~P.~Aleksandrov:]
...
\item to the world community they reported, succinctly and clearly, that operation at power below \qty{700}{\mega\watt} was prohibited by the Regulations.
\end{itemize}
...
Indeed, the Turbogenerator run-down mode is used for one of the ECCS subsystems during a design basis accident. But what is meant thereby is to ensure the operation of the feedwater pumps only; the remaining mechanisms are of secondary concern. The Main Circulation Pumps are not counted upon during a design basis accident, since depending on the nature of the accident they may be torn off within the first seconds. Of the long quotation above, only the last sentence is partially correct.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``Similar tests, but with the reactor's active protections in place, had been conducted earlier at the Chernobyl Nuclear Power Plant and at other nuclear power stations. I also had to take part in them.''} (p.~16)
\end{personal}

All Emergency Protection systems for the given mode were in place this time as well.

At other stations no such tests were conducted -- something Medvedev himself writes in his tale.

I took part in all these tests, and never saw Medvedev at any of them. And in what capacity would he have taken part, being occupied with equipment deliveries?

\bigskip
\textbf{A true documentalist!}

The words alone are correct, but not the content they express.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``When the reactor is loaded with fresh fuel, its reactivity margin (to put it simply, the capacity for growth of neutron power) exceeds the capacity of the absorbing rods to suppress the reaction. In such a case, part of the fuel (assemblies) is removed and in their place fixed absorbing rods are inserted (they are called additional absorbers -- DP), as if to assist the movable rods. As the uranium burns up, the DP are removed and nuclear fuel is installed in their place.}

\textit{However, one inviolable rule remains: as fuel burns up, the number of absorbing rods loaded into the active core must not be fewer than twenty-eight to thirty (after the Chernobyl accident this number was increased to seventy-two), since at any moment a situation may arise in which the fuel's capacity for power growth proves greater than the absorbing capacity of the regulating rods. These \num{28}~to~\num{30} rods, located in the zone of highest effectiveness, \ul{constitute the operational reactivity margin} (emphasis mine -- A.\,D.). In other words, at all stages of reactor operation its capacity for a run-away must not exceed the capacity of the absorbing rods to shut the reactor down.''} (p.~17)
\end{personal}

Those who understand reactor physics, do not despair, and do not call yourselves blockheads if you understood nothing from this lengthy excerpt. There is nothing here to understand. It is a case of having heard a bell but not knowing where it hangs. Here is what the matter actually is. After the first unit of the Leningrad Nuclear Power Plant was commissioned, as fuel burned up the DP began to be extracted and replaced with fuel assemblies. It was noticed that the reactor was becoming ever more ``capricious'' -- to control it, rod movements had to be commanded up to 40~times per minute. This was a consequence of the increasing steam (void) effect of reactivity. Measurements were taken and recommendations were issued to reduce it: increase the enrichment of the fuel in Uranium-235 (at the Leningrad plant it was \qty{1.8}{\percent}) or leave some of the DP in place.

It was then decided to retain no fewer than \num{30}~DP in the active core. This is, of course, insufficient at an enrichment of \num{1.8} and even \qty{2.0}{\percent}.

Subsequently, fuel enrichment was raised to \qty{2}{\percent}; science blithely declared this sufficient, and from then on all DP were extracted, since they adversely affect fuel economy. Thus, at the fourth unit of the Chernobyl plant by 26~April only one DP remained in the core -- I no longer recall why it was left.

The DP have no bearing on the operational reactivity margin. It is compensated (absorbed, suppressed) by Control and Protection System rods -- RR, AR, and USP -- and can be rapidly (operatively) freed by the reactor operator. To extract a single DP using the refuelling machine takes several hours -- what ``operativeness'' is there in that?

Forgive me for so lengthy an excerpt from the tale, but it is necessary. Further on in the text, the author repeatedly and just as perversely misinterprets, invokes the concept of the operational reactivity margin, and purports to explain the processes under way. How can one explain to others what one does not understand oneself? Or on the principle that if you explain it to people five times, you may come to understand it yourself.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``In January 1986, the director of the Nuclear Power Plant, V.~P.~Bryukhanov, sent the test program to the general designer `Gidroproekt' and to Gosatomenergonadzor for approval. No reply followed. Neither the directorate of the Chernobyl Nuclear Power Plant, nor the operational production association Soyuzatomenergo was troubled by this. Nor were `Gidroproekt' and Gosatomenergonadzor troubled by it.''} (p.~17)
\end{personal}

And over the following two pages Medvedev describes what irresponsible people they are and how nothing good should be expected of them.

To lend verisimilitude he even states specifically ``in January 1986.'' Remember how in Saltykov-Shchedrin the next governor-general is described: found in bed, bitten to death by bedbugs, in 1856. No. The program was signed by the Chief Engineer on 24~April 1986.

By this I do not in the least wish to say that Gosatomenergonadzor and ``Gidroproekt'' discharged their duties impeccably -- but neither do I wish to prove that they did not.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``Here it is necessary to add one more detail, which was not mentioned in any of the technical reports on the incident. Here is that detail: the mode with the Turbogenerator rotor run-down with removal of AZ from service was planned in advance and was not only reflected in the test program but also prepared technically. Two weeks before the experiment, on the panel of the unit control room of the fourth unit, an MPA button was installed, whose signal activated only secondary electrical circuits, but without the monitoring and measuring instruments and the pump section. That is, the signal from this button was purely simulated.''} (p.~19)
\end{personal}

Oh, how he digs! He unearthed the button. But he is not the first. It appears in the forensic experts' records and in the Indictment. The button was installed not two weeks beforehand but on 25~April, as witness electrician Mole testified. Without the program, the operators would not have allowed anything to be installed.

In the commission records there is no mention of this button, since for the purpose of accusing the personnel nothing can be extracted from it. Only the forensic experts and Medvedev inject living current into it. The experts say that no documentation for it existed, while Medvedev simply made the whole thing up. That is exactly what he says.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``Let me explain once more for the general reader: when AZ is actuated, all \num{211} absorbing rods drop downward, cooling water is turned on, emergency pumps are activated and reliable-supply diesel generators are brought up to speed. Also activated are the pumps for emergency water supply from the clean-condensate tanks and the pumps delivering water from the bubbler pool into the reactor. That is, there are more than enough means of protection, provided they actuate at the right moment.}

\textit{And all of these protections were supposed to have been linked to the MPA button. But they had, unfortunately, been taken out of service, since the operators feared thermal shock to the reactor, i.e.\ the admission of cold water into the reactor. This feeble notion had apparently mesmerised both the management of the Nuclear Power Plant (Bryukhanov, Fomin, Dyatlov) and the higher organisations in Moscow.''} (p.~19)
\end{personal}

Medvedev has jumbled everything together. For different signals the actuation sequences and mechanisms are different. Let us note that he speaks of AZ during a design basis accident. But during the experiment the circuit was not expected to rupture at all -- so why, then, connect the ECCS cylinders and the pumps delivering water from the bubbler pools? There is simply nowhere to pump the water -- the drum separators are full.

The Emergency Core Cooling System is designed for use during a design basis accident. On 26~April 1986, it was not a design basis accident but something else. How to classify it I do not know; it is called a maximum hypothetical accident. So be it!

I shall not adduce any further considerations. I believe that people with feeble ideas should listen to the wise counsel of an experienced nuclear-plant operator. And if this really could have prevented the accident -- well, as the saying goes, trust but verify. They accepted Medvedev's idea about activating the ECCS upon the start of the Turbogenerator run-down. How could this have influenced what was happening in the reactor? Coolant flow was already high enough, so merely adding cold water to the reactor -- specifically, to its active core -- would have reduced steam formation and, consequently, reactivity. Only the ``instantaneous'' part of the ECCS need be considered; all the rest is irrelevant. Let us agree that the button would send both the MPA signal and the AZ signal.

The time should be taken from the registration system of the centralised monitoring system ``Skala,'' and not from what is given in the tale, taken from who knows where:

\begin{quote}
01~h 23~min 40~s -- AZ-5 button pressed,\\
01~h 23~min 46\ldots47~s -- explosion of the reactor.
\end{quote}

This means we had \num{6}~seconds at our disposal, since by then pressure in the circuit had already risen, and the supply of water even by the feedwater pump would have ceased, to say nothing of the cylinders.

The problem before us is straightforward. Will the cold water reach the active core in \num{6}~seconds? If so, it might have some effect. A calculation, which I do not reproduce here, shows that even with incomplete opening of the valves from the header at the \qty{+30}{\metre} elevation, the water reaches the core in more than \qty{10}{\second}.

And \num{10}~seconds later this water would have had nothing left to act upon. The active core no longer existed.

The other variant, when the ECCS is activated upon closure of steam to the turbine and the AZ button is pressed \num{36}~seconds later -- as actually occurred at the unit -- yields nothing either. In \num{36}~seconds the cold water will have passed through the entire core, and the negative reactivity it introduces will have been compensated by the automatic power regulator.

Such is the state of affairs with Medvedev's advice to activate the ECCS.

\textit{Know thy subject, if thou wouldst speak of it.}

I have dwelt on this matter at such length for the following reason: while I was still in detention, awaiting conclusion of the proceedings, a charming French television correspondent kept pressing me about why the water had not been supplied. I simply could not fathom what water she was talking about. Only when the filming was over and she mentioned that she had read Medvedev's book did I understand what water was in question. And the tale continues to travel the world, sowing its lies.

Even the tendentious commission of forensic experts was compelled to acknowledge that disconnection of the ECCS had influenced neither the initiation nor the development of the accident.
...
\textit{Did Bryukhanov, Fomin, Dyatlov, Akimov and Toptunov understand this entire chain?''} (p.~27)
\end{personal}
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``At 01:07 a.m., to the six operating Main Circulation Pumps, one more each was additionally switched on, with the calculation that after the experiment ended four Main Circulation Pumps would remain in the circulation loop for reliable cooling of the core''} (p.~30).
\end{personal}
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``One asks: was it possible in this situation to avoid the catastrophe? It was possible. One only needed to refuse the experiment, connect the ECCS, reserve the power supply, and by hand, in steps, lower the power all the way to shut-down, in no case performing a SCRAM, for that would have been tantamount to an explosion\ldots But this chance was not used.''} (p.~30)
\end{personal}

He has offered his counsel. The matter was simpler. One needed only to lower six control rods into the core, then another six, until shutdown, and then trigger AZ. One could have begun with the regulators. All this is clear only \textit{now}, after the reactor's unnatural Emergency Protection property has become known. ECCS and power manipulations were unnecessary.

% --
I didn't understand it at the time. And if I had possessed such prophetic insight, I might as well have performed for Kashpirovsky, Chumak, and Tarasov\footnote{Soviet perestroika-era television healers and supposed miracle-workers.} and claimed a chestful of medals, more so than Brezhnev. In other words: only a psychic could have pieced it together then.
% --
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``And suddenly Perevozchenko flinched. Strong and frequent water-hammer blows began; \num{350}-kilogram cubes -- 'assembly eleven' -- jumped on the channel heads as though seventeen hundred men tossed their caps in the air. The whole surface of the platform came alive, heaving in a wild dance; the biological-shield boxes around the reactor shuddered and buckled. This meant that pops of the detonating gas mixture were already going off beneath them\ldots''} (p.~33)
\end{personal}
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``Thus, if one believes the machine, in the upper third of the core there formed a flattened sphere of high energy release, about seven metres in diameter and up to three metres high; it was precisely in this part of the core (weighing about fifty tons) that the run-away on prompt neutrons chiefly took place, that the heat-transfer crisis occurred, that destruction, melting, and then evaporation of the nuclear fuel took place. It was precisely this part of the core that the explosion of the detonating gas mixture threw high into the atmosphere\ldots''}
\end{personal}
...
While on leave, I stopped in Pripyat and agreed with Director V.~P.~Bryukhanov about the post of deputy head of the Reactor Department. We did not speak of the department head's post; that post was already filled. When I spoke with Bryukhanov no one else was present, and Medvedev has nothing to do with it. In general, he clearly exaggerates his role in staffing the station; he left in 1974, when no money whatsoever had yet been allocated for recruiting personnel. Incidentally, this is the surest indicator of whether the Ministry believes in a scheduled start-up date: if no money is allotted for recruiting, there will be no start-up. It is possible that Medvedev did speak with Bryukhanov about people in general, but only in principle; concrete individuals could not yet have been under discussion.

I arrived at the station after receiving a summons in September 1973, after fourteen years at the plant. Submarine reactors are, of course, different in design and much smaller in size. But they are no toys -- real power reactors. At Chernobyl I served as deputy, then as head of the Reactor Department, and from February 1983 as Deputy Chief Engineer for Phase~II.

The accusations levelled at Dyatlov by Medvedev have no foundation.

\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}:]
\textit{``So then, was Dyatlov capable of an instantaneous, uniquely correct assessment of the situation at the moment of its transition into an accident? I think not. Moreover, he apparently did not possess to a sufficient degree the necessary caution and sense of danger, so needed by the leader of nuclear operators. What he did have in abundance was disrespect towards the operators and the technological regulations\ldots~It was precisely these qualities that unfolded in Dyatlov in full force when, after the shutdown of the Local Automatic Regulator, Senior Reactor Operator Leonid Toptunov was unable to hold the reactor at a power of \qty{1500}{\mega\watt} and let it drop to \qty{30}{\mega\watt} (thermal)''} (p.~24-25).
\end{personal}
...
In his tale Medvedev speaks of two operators from the previous shift who remained to observe, Yu.~Tregub and S.~Gazin. Here is what they wrote in response to my questions.
...
Medvedev's remark that Toptunov and Akimov behaved bravely, but to no purpose, is immoral. Leonid, by virtue of his post, indeed could no longer influence events. But by his conduct -- returning of his own accord to the unit -- he set an example of devotion to duty. And all the work of switching off loads, de-energizing, draining turbine oil, purging hydrogen from the generators -- in short, preventing new fires -- was carried out under Aleksandr Akimov's direct leadership. Nothing more useful could have been done in that situation. What \textit{was} done is much, and it was necessary. Aleksandr Akimov was a good, exceptionally conscientious worker. And he died with the dignity of a Human Being.

We have examined the technical part of Medvedev's tale. Note the first quotations I cited and their page numbers. You will see that practically everything is incorrect. The remaining words between them serve only as ligatures. I did not continue to take the text further; but believe me -- or verify it yourself -- beyond that everything is equally wrong. One falsehood after another, sequentially.
...
\textit{``In the Chronicle pressure bears down on Dyatlov, and Dyatlov bears down. A system of pressure unfolds like a fan. Dyatlov presses, Fomin presses, Bryukhanov presses, Shcherbina presses\ldots\,The Chronicle records the `physiology' of pressure, its processes and reactions, observable and recordable. And those who press and those upon whom pressure is exerted -- in the end they are not divided into opposing camps.''}
\end{personal}
...
\begin{personal}[From I.~Borisova's article in \textit{Oktiabr}; No.~10 of 1990:]
\textit{``Before the explosion Dyatlov insisted on continuing the Turbogenerator rundown experiment, ignoring the emergency reality.''}
\end{personal}
...
At the very first interrogation I pointed out how unfounded the accusation of the personnel was regarding a violation of the Regulations by blocking AZ. You think that had any effect? Not in the least. At the trial the judge kept insisting on knowing who had ordered the protections to be disabled. And when Yelshin and other witnesses answered that, in their opinion, under operational discipline, Akimov could not have disabled protections on his own, the judge drew the conclusion: Dyatlov gave the order -- he is guilty. But, first, since when has ``in one's opinion'' become evidence? Second, from the case files the judge knew that whether Dyatlov had ordered it or Akimov had disabled the protections on his own, there was no violation. And third, for the purpose of blaming Dyatlov this is quite enough, whereas for drawing the conclusion that the personnel had been trained to strict discipline it is not enough.
...
\item According to Clause 3.3.26, AZ must reliably and rapidly shut down the chain reaction when the button is pressed. And it was precisely from the pressing of the button that the accident began.
\end{itemize}
...
\chapter{The Investigation Has Begun}
...
Pump shutdowns -- and shutdowns much faster than in the experiment -- are possible in normal reactor operation, for example when a power bus section trips. Does this mean that under such conditions one could not work at all? In fact, that is how it was; but the experiment has nothing whatsoever to do with it.

% --

\section{The Report of A.~A.~Yadrikhinsky, Inspector of Gosatomenergonadzor at the Kursk Nuclear Power Plant}

In the work of A.~A.~Yadrikhinsky, for the first time the question is raised explicitly of the compliance of the RBMK reactor, in its 1986 configuration, with the principal regulatory documents on nuclear safety -- the OPB and NSR.
...
\ul{Similar thermohydraulic parameters can arise during any reactor shutdown for refuelling (underlined - A.D.).}

The initial state of the unit immediately before the tests at 01:23 a.m. was characterized by the following: power -- \qty{200}{\mega\watt}; reactivity margin (value obtained after the accident using the PRIZMA-ANALOG code for the state at 01:22:30 a.m.) -- 8~(RR) rods; the axial power profile was double-humped with a maximum at the top; coolant flow -- \qty{56000}{\meter\cubed\per\hour}; feedwater flow -- \qty{200}{\tonne\per\hour}; thermophysical parameters close to stable. The management of the unit shift judged the preparations for the tests to be complete, and after the oscillograph had been switched on, an order followed to close the stop-control valves, which were closed at 01:23:04 a.m.
...
Nevertheless, despite a number of imprecise (though not, I think, prejudiced) formulations, the report ought to exert a salutary influence upon the investigation of the accident's causes. Above all, because it officially recognizes that the RBMK reactor, in its 1986 incarnation, failed to conform to the fundamental requirements of the regulatory documents on nuclear safety. Yet it seems that a protracted struggle (I use the word with reluctance)\footnote{\textit{длительная борьба} was commonly used to describe the "long struggle" against the enemies of communism. The author's reluctance here owing to his disdain for the Soviet regime or at the very least the common meaning behind this phrase.} still lies before us in the pursuit of truth. The opposing side is numerous and remains influential.
...
\begin{personal}[From V.~P.~Volkov's letter to M.~S.~Gorbachev:]
...
Thereafter, ``pump rundown'' disappears entirely as a causal explanation -- it is far too compromising. The Soviet informants to the IAEA expounded the runaway phase in a wholly incoherent manner. A new formula was accordingly devised:
...
To this I add: such adversity exists only on such a reactor, under such an emergency configuration.
...
\begin{itemize}
  ...
  \item retaining additional absorbers (DP) in the core;
...
\begin{personal}[From G.~Medvedev's \textit{The Chernobyl Notebook}]
\textit{``The officer and soldiers are not wearing respirators; they hang on their necks. Illiteracy from poorly organized training\ldots~After all, future generations will come from these young men. Even \qty{1}{\roentgen\per\Year} gives a \qty{50}{\percent} probability of mutation\ldots''}
\end{personal}

This would indeed be terrible -- if it were true. The entire world proceeds on the assumption of five rem per year for professionals. But the number of such professionals is large. Not all receive the full permissible dose. Yet, for example, the repair personnel of reactor departments practically all receive that dose each year. At five rem per year, then, mutations ought to be more frequent still than at one roentgen -- so where are the anomalies? Why does neither the population nor the medical profession observe them? As with so much else, Medvedev's claim is conjured out of thin air.
...
\begin{personal}[From N.~P.~Dubinin's article]
...
Pay no heed to the differing units -- roentgen, rad, rem: for $\gamma$- and $\beta$-radiation they may be treated as equal; other kinds of radiation an ordinary person does not encounter. Thus, according to the UN committee, a single dose of \qty{30}{\roentgen} or a chronic dose of \qty{100}{\roentgen} can double the mutation rate over the natural background. Given that the natural background already yields roughly \num{70} congenital defects per \num{1000} newborns, even doubling the dose does not produce anything like a \qty{50}{\percent} mutation rate.
...
On the other hand, so much falsehood has been heaped up around Chernobyl that it is exceedingly difficult for any person to make sense of it. Therefore I set forth the factual events, and the article of the Nuclear Safety Rules (NSR), and I invite the Reader to assess for himself how, for example, AZ fulfilled the requirements of that article. I am virtually certain that I have not allowed inaccuracies in the description of events.
...
The Kurchatov Institute Report lists thirteen hypothesised causes of the reactor's destruction, and on the basis of instrument readings and calculations rejects all but one -- the AZ rods introduced positive reactivity, which served as the initiator of the accident.
...
I refuse to dignify the fact of positive reactivity insertion by AZ at its actuation with the term ``design feature.'' It is impossible. As Vitya Tarasenko put it -- it is an oxymoron. It is such a brilliantly absurd idea, on the part of the designers of the control rods, that it could have arisen only in heads whose owners had taken ``seven hundred grams apiece.''\footnote{A caustic, colloquial insult. ``Seven hundred grams'' refers to a very large amount of vodka. He is saying, sarcastically, that only someone drunk out of his wits could conceive such an idea -- that a shutdown mechanism would initially increase reactivity rather than suppress it.}

Once the fact that AZ destroyed the reactor is acknowledged, what further talk of the personnel's guilt is even conceivable?

It appears -- such talk is possible. Where morality is inverted, all things are possible.

And still, dear citizens, gentlemen: whenever, in discussing the Chernobyl tragedy, you feel tempted to cast a stone at the operators, remember -- the reactor was destroyed by AZ. This phenomenon defies engineering comprehension. An eternal monument to the bungling of physicists and designers.
...
\item[3.6] Effect of the Control and Protection System control-rod displacers.
...
\item[3.13] Ingress of compressed gas from ECCS cylinders.
\end{enumerate}
...
In 1986, the IAEA's International Safety Advisory Group released INSAG-1, its report on the causes of the accident at Chernobyl. Seven years later the group's revised report on the accident, INSAG-7, appeared. Seven years is long enough to study a lot of research and to formulate an opinion. Upon the release of INSAG-7, the journal \textit{Nuclear Engineering International} published an article by Mr.~James~Varley, \textit{``Who is to blame for the Chernobyl accident -- mature reflections of the International Advisory Group on Nuclear Safety''} (\textit{NEI}, May~1993). Let us try to assess the maturity of the experts' reflections.

\section*{Subcooling of the coolant}

For eight years now the erroneous assumption has been going the rounds that because of the high coolant flow rate, coolant subcooling at the core inlet was reduced, boiling began right at the bottom of the core, and this led to thermohydraulic instability. I pointed out the falsity of this assumption back in 1986, in a letter addressed to the Director General of the International Atomic Energy Agency.

\begin{personal}[INSAG-7 (§2.9):]
\textit{``These conditions led to the onset of boiling at or near the bottom of the core.''}
\end{personal}

According to the Regulations, subcooling is the difference in water temperature in the drum separators and at the core inlet. It certainly does fall with an increase in coolant flow rate, but when this happens the pressure at the core inlet rises, and so also does the boiling temperature (see Figure~1). At low reactor power, boiling begins beyond the core anyway, in the steam-water communication (SWC) line pipework, and the location of boiling moves down gradually as power rises (Figure~1). The greater the flow rate, the higher the starting point for boiling. Specifically, on 26~April (the date of the accident), at a reactor power level of \qty{200}{\mega\watt} (power level in core centre channel around \qty{160}{\mega\watt}), boiling was beginning right at the top of the \qty{7}{\meter} high core (see Table~1 and Figure~2).

\begin{personal}[INSAG-7 (§5.2.3):]
\textit{``The reactor was operated with boiling of the coolant water in the core and at the same time with little or no subcooling at the pump intakes and at the core inlet. Such a mode of operation in itself could have led to a destructive accident \ldots{} in view of the characteristics of positive reactivity feedback of the RBMK reactor.''}
\end{personal}
...
On 26~April subcooling was roughly \qty{1}{\celsius} and pressure was slowly building (see Table~2).

\section*{Main circulation pumps}

The INSAG experts have reanimated the long-discredited theory of pump breakdown, due to loss of head and pump cavitation. But there was no circulation breakdown. If the pumps did not break down during pressure decrease, why did they break down during a rise in pressure? The monitoring system recorded proper operation of the pumps right up to the sudden power surge. Pumps powered by a generator that was running down could not in any way have suffered breakdown. There are no reasons why they should. The first to be switched off, though, were those very ``running down'' pumps (see INSAG-7, Annex~I, Table~I-I), then, powered from the back-up supply. This indicates that the cause of the cessation of coolant delivery was a sharp surge of power.

There is further evidence, but if this is not sufficient for the experts, I suppose nothing is going to convince them.

This reactor really did explode when the main circulation pumps were stopped. But this could have happened when the steam lines ruptured, on opening and failure to reseat of the main safety valves, during the maximum design accident\ldots{} The only people that can be blamed for this, though, are the reactor designers.

Just to conclude the subject of the main circulation pumps:

\begin{personal}[INSAG-7 (§2.8):]
\textit{``Furthermore, since there is not much change in fluid temperature between the coolant pumps and the core inlet, the temperature of the water in the pumps and at their intakes is near boiling if the subcooling is very small.''}
\end{personal}

This is a strange sort of explanation instead of the straightforward and obvious one: the temperature at the pump intake approaches boiling point at a high coolant flow rate because of the lower level of cooling of it by the feed water and the increase in loss of pressure head in the downcomer (see Figure~1).

\begin{personal}[INSAG-7 (§2.9):]
\textit{``When the turbine was tripped, the four pumps it was powering began to slow down as the turbine speed was reduced and the associated generator voltage fell. This reduced rate of core flow caused the void content of the core to rise and caused an initial positive feedback of reactivity, which was at least in part the cause of the accident.''}
\end{personal}

The fall by \qty{10}{\percent} in flow rate over the \qty{36}{\second} of rundown of the turbine caused a rise in reactivity which the automatic regulator was able to handle. There was no increase in power; it is sufficient to look at the power graph submitted to the IAEA in 1986. This is discussed in Annex~I of INSAG-7 (§I-4.6.2). If that is not enough, I could ask E.~V.~Burlakov of the Kurchatov (one of the expert advisors to INSAG), and he could present the 1986 calculations of his colleague A.~Apresov (see Table~2).

During the rundown period, the coolant density altered by \qty{6}{\kilogram\per\meter\cubed}, giving a rise in reactivity of the order of \num{24e-6}; under real conditions the rate of change of reactivity can be several times greater.
...
\begin{enumerate}
\item The potential for power manoeuvring.
\item Fuel burnup compensation.
\end{enumerate}

These are functions natural to all reactors, and they are described in books and in regulations.

\begin{enumerate}\setcounter{enumi}{2}
\item Controlling power density over the volume of the reactor.
\end{enumerate}
...
\item A guarantee that the reactor protection operates properly. At the same time the restriction is imposed not on the maximum, which would be natural, but on the minimum~(?).
\item Not only is proper operation ensured at a certain operating reactivity margin, but a given rod configuration must continue to be maintained.
\end{enumerate}
...
\begin{personal}[INSAG-7 (§5.1):]
\textit{``A particular configuration of control and safety rods was necessary for the positive scram to occur\ldots{}''}
\end{personal}
...
\item And finally, yet another function of ORM: keeping the steam void coefficient of reactivity within set limits.
\end{enumerate}

\begin{personal}[INSAG-7 (§4.2):]
\textit{``In the discussion of the scenario, the operators seemed not to be aware of the other reason for the importance of the ORM, which was the extreme effect it could have on the void and power coefficients.''}
\end{personal}
...
Here the alteration to the operating reactivity margin occurs through poisoning of the reactor, in other words the appearance of xenon is compensated by rod withdrawal. Although the influence on the multiplication factor is of the same order, however, the effect on the void coefficient is not identical. And that is by no means obvious.

But let us examine the effect anyway. The regulations give a magnitude for the operating reactivity margin of from 30 to 15 rods. A reduction to 15 rods cannot be blamed on the operators, because in fact there is no other way to operate. The operators overlooked (there was no means of observing) a fall in the operating reactivity margin to eight rods. So, they have 7 rods on their conscience. In an article by N.~Laletin (\textit{Atomnaya Energiya}, 1993, Vol.~74, No.~3), a change in the operating reactivity margin by 25 rods alters the void effect by \qty{0.5}{\percent}. Thus seven rods added \qty{0.14}{\percent}. That was bad, but it was not this addition that played the fatal role, it was the existing void effect of reactivity (\qtyrange{2.5}{3.0}{\percent}). You definitely do not have to be a top ranking international expert to understand this.

After the accident, 80 additional absorbers were located in the core. Each additional absorber is equivalent to a control and safety system rod in terms of its influence on the void effect of reactivity. But even 80 was too few, and it was not possible to fit in more, since they are installed in the fuel channels and therefore reduce the number of fuel assemblies. Solely from necessity the operating reactivity margin was raised to \numrange{43}{48} rods with the fall in the margin restricted to 30 and no less. This margin is not needed for operation, and anyway the operator is forbidden from using it; he has 15 rods at his disposal, as before the accident. A large reactivity compensated by operational systems is a fairly odd way of improving safety. Strange how things are managed with the RBMK reactor. Before the accident it was the only reactor in the world which was especially nuclear-hazardous with a small reactivity margin.

\section*{Void coefficient}

Both in the INSAG experts' report and in other documents there is mention of the void coefficient of reactivity, whereas what should have been mentioned is the void coefficient of inadmissible magnitude. It turns out that after the accident at the Leningrad power station in 1975, the Scientific and Technical Council of the Ministry took a decision to set this at no more than \qty{0.5}{\percent}, a fact which the creators of the reactor ``successfully managed'' to forget. They were quite happy with the calculated curve~1 in Fig.~II-12 of INSAG-7 Annex~II (curve~1 of Figure~3 in this article).

\begin{figure}[h]
\centering
\includegraphics[width=0.45\textwidth]{fig2.jpg}
\caption{Dependence of reactivity $\rho$ (\unit{\percent}) on coolant density $\gamma$ (\unit{\gram\per\centi\meter\cubed}): 1~-- design calculations; 2~-- actual dependence at the moment of the 26~April~1986 accident; 3~-- current state after implementation of corrective measures.}
\end{figure}

A few comments on this figure.

Curve~1 does not guarantee safety -- the reactivity overshoot with a change in density to \qty{0.4}{\gram\per\centi\meter\cubed} is \qty{2}{\betaeff}. The error is the same as for a change in reactivity compensated by the control and safety system rods -- only the extreme states are considered.

Curve~2 of Figure~3 is shown in INSAG-7 as the actual dependence at the same time of the accident on 26~April. This is a Jesuitical approach -- neither a lie nor the truth. A similar void effect existed at all RBMK reactors, and not only on 26~April. The curve was obtained several years prior to the accident by an employee of the Kurchatov Institute, V.~Ivanov, and was subsequently confirmed by measurements. The administration did not believe Ivanov. They understood that an explosion threatened, but they did not check this out either by calculation or by experiment. So there you have it. One might ask why Ivanov did not squeal? Only one person squealed, and that was V.~P.~Volkov, who was quickly disposed of with an invalidity pension.

The INSAG experts too employ some dubious approaches.

\begin{personal}[INSAG-7 (§4.2):]
\textit{``Under the circumstances of the accident, the void coefficient increased to such an extent that it overwhelmed the other components of the power coefficient, and the power coefficient itself became positive.''}
\end{personal}
...
In Annex~I to INSAG-7, page~36, we read: \textit{``Second generation plants with the RBMK-1000 reactor (Leningrad units~3 and 4, Kola units~3 and 4, Chernobyl units~3 and 4, Smolensk units~1 and 2) were loaded from the beginning with fuel enriched to \qty{2}{\percent} in uranium-235. However, even with that fuel enrichment, as fuel burnup increased to \qtyrange[range-phrase=\text{--}]{1100}{1200}{\mega\Wd\per\tonne} per fuel assembly, and with an authorised operating reactivity margin (ORM) corresponding to \numrange{26}{30} manual control rods, the void coefficient of reactivity approached \qty{+5}{\betaeff}. There were similar fuel burnups at Chernobyl unit~4 before the accident.''} Further, at such a void coefficient of reactivity, the power coefficient is \qty{+0.6e-4}{\betaeff\per\mega\watt} at a power greater than \qty{50}{\percent}. At lower power levels it is more positive still.

In the article by N.~Laletin referred to above, it says: \textit{``It is significant that the void effect for a core with even burnup is roughly twice as great as for a core with the same average burnup but distributed over the fuel channels from zero up to roughly double the mean value. It follows from this that the state of the reactor at the end of the transition phase, when all additional absorbers are removed, is more hazardous than its state when reload fuel is installed, although this fuel is comparable in terms of mean burnup.''}
...
The core of unit~4 was in fact at the end of the period: 1~additional absorber; 1~unfuelled channel; 1659~assemblies with an average burnup of \qty{1180}{\mega\Wd} per assembly. The bulk of the assemblies (\qty{75}{\percent}) were first-charge assemblies with a burnup of \qtyrange{1150}{1700}{\mega\Wd} per assembly.

The void effect may be said to have been greater than \qty{+5}{\betaeff}, although that itself would have been quite enough for an explosion.
...
\begin{personal}[INSAG-7 (§2.1):]
\textit{``Thus, although the void coefficient of reactivity varied over a wide range from negative to positive values as a function of the composition of the core and the operating regime of the reactor, the fast power coefficient remained negative under normal operating conditions. At the time of the accident, the void and power coefficients of reactivity were both positive.''}
\end{personal}
...
\section*{Further comments on INSAG-7}

\begin{personal}[INSAG-7 (§4.1):]
\textit{``The scram just before the sharp rise in power that destroyed the reactor may well have been the decisive contributory factor.''}
\end{personal}
...
This is something new. Why did the experts not tell us the cause of the impending power excursion, or at least make a stab at it?

Not one of the commissions have ever found the cause.

I would like to state the following, as a witness to the event: the protection button was pressed in calm circumstances. There is also the evidence of G.~Metlenko and A.~Kukhar. Annex~I of INSAG-7, §I-4.9, says that the commission could find no reasons why the emergency protection rods were dropped. There was actually one reason for dropping the protection rods: a wish to shut down the reactor when work was finished.

Dropping the protection did not ``facilitate'' the destruction of the reactor, it caused it.

\begin{personal}[INSAG-7 (§4.1):]
\textit{``Failure of a fuel channel would have been a cause of a sudden local increase in void fraction as the coolant flashed to steam; this would have led to a local reactivity increase which could have triggered a propagating reactivity effect.''}
\end{personal}
...
\begin{personal}[INSAG-7 (§5.2.1):]
\textit{``The statement was made that there was a proscription on continuous operation of the reactor at power levels below \qty{700}{\mega\watt}(th). This statement was based on incorrect information. There should have been such a proscription, but there was none at the time.''}
\end{personal}

This reactor ``managed to'' explode even at \qty{700}{\mega\watt}. There was no safe power level for it. There were only more or less hazardous levels. On the other hand a reactor meeting design norms does not need a restriction of this kind.

There is no technical safety case for power levels over \qty{700}{\mega\watt}. It took on what can only be called a mystical aura (obliging academicians and scientists to make misleading statements before the whole world) solely in order to place blame on the staff.

I set the \qty{700}{\mega\watt} level when I drew up the experimental programme at Chernobyl, and it was based on incidental considerations. At the time the programme was drawn up, it was assumed that we would be checking the main safety valves, for which considerable power was needed -- the capacity of a single valve is \qty{725}{\ton\per\hour} of steam. Since performance of the turbogenerator rundown programme was placed right at the end (because of having to place most of the mechanisms on reserve power -- these are the safety measures which the programme was criticised for lacking), and the reactor was being shutdown for this, in order not to have to wait for a fall in power, the level for the proposed preceding work was entered.

After the unplanned reactor power dip, I took the decision to keep to a rise to \qty{200}{\mega\watt} in view of the adequacy of this, and not because of impossibility. Surely it is obvious that with a positive fast power coefficient there are no limitations on raising power?

Of course it was borne in mind in taking this decision that \qty{200}{\mega\watt} is the usual power level permitted by the regulations.
...
\begin{itemize}
\item Void coefficient to be lowered.
\item Design of control and safety system rods to be altered.
\item Fast-acting emergency protection to be installed.
\end{itemize}
...
All this, however, was determinedly ignored by the Soviet administration, including some of the experts recently advising the IAEA: Yu.~Cherkashov, V.~Sidorenko and A.~Abagyan. And this, to answer a point raised by James Varley (Editor of \textit{NEI}) in his May 1993 article on INSAG-7, is why there has been so little benefit from the inclusion of senior officials among the INSAG experts, despite the fact that they had access to equipment, computers, details of reactor characteristics etc.
...
\section*{Causes of the accident}
...
In 1986, for example, V.~Legasov and A.~Abagyan did not report the fact that the emergency protection had introduced positive reactivity. Presumably because this was considered unpalatable. The experts write that if they had known, the conclusion would have been different. They found out. And they came to a conclusion: they effectively blamed the staff for dropping the protection rods (see INSAG-7 §4.1, as quoted above). This sort of thing was not done even at the time when the staff were being most virulently blamed.

In §6.6 of INSAG-7 the experts write: \textit{``Yet INSAG remains of the opinion that critical actions of the operators were most ill-judged.''}

Now let us consider a reactor that meets design norms. Which operator actions are ill-judged, or critical? How and why should the operators have compensated for design errors they did not know about?

It was only because there was no legal basis for blaming the staff that V.~Legasov and A.~Abagyan were forced to resort to making the misleading statements they made in 1986. What is amazing is the promptness with which the INSAG experts grasped these incorrect statements and made their stand as public prosecutor.
...
These safety measures are lacking in the following units, which are in use at the present time: Units 1 and 2 of type AMB reactors at Beloyarsk AES, VVER-440 type reactor Units 1, 2, 3, and 4 at Kola AES, VVER-440 Units 1 and 2 at the Armenian AES, RBMK-1000 type reactor Units 1 and 2 at Leningrad AES, RBMK-1000 reactor Units 1 and 2 at Kursk AES, and RBMK-1000 reactor Units 1 and 2 at Chernobyl AES. [comment: this passage was underlined]
...
Chief of the 3rd Department of the 6th Service of the KGB Administration of the USSR for the city of Moscow and Moscow Oblast
...
\textit{Translator's note:} This document also originates from the archives of the Ukrainian KGB. It is a report dated 1 March 1984, from the Head of the Pripyat City Department of the Ukr. SSR KGB Administration to the Head of the USSR KGB Administration for the city of Kiev and Kiev Oblast, Lieutenant General M.Z. Banduristiy. This report discusses to violations of reactor design plans and the disintegration of load-bearing concrete due to extreme temperatures and improper wall insulation.
...
On July 18th, 1984, an interview was held with trusted individual \textit{"Zh. V. A,"} a highly qualified specialist in the area of atomic energy and an employee at the \textit{"Energy"} All-Union Scientific Research Institute for the Use of Atomic Energy Stations NPO.
...
As far as the trusted individual is aware, such problems were not observed at the Leningrad atomic energy station, since bushing is stretched over the joints that heats up first and additionally pulls the steel-zirconium adapter together when it cools. However, it is technologically difficult for the metallurgical factory in the city of Glazov, in the Udmurt ASSR to produce joints like the ones at the Leningrad atomic energy station, because the quantity of such joints that is needed is large, and the time needed to produce them is increasing. The factory will not be able to fulfill the output plan it was given for steel-zirconium joints in accordance with the plan for launching the RBMK type reactor.
...
\begin{flushright}\small{
-- Captain A. E. Nikiforov, [Signature]
}\end{flushright}
...
To the Head of the Pripyat City Department of the Ukr. SSR KGB Administration

For the City of Kiev and Kiev Oblast

To Lieutenant Colonel Comrade Yu. V. Nikolaev
}\end{flushright}
...
\paragraph{2.1.11.}
For systems and devices important to safety, a direct and complete verification of conformity to design characteristics shall, as a rule, be carried out. If such verification is impossible, indirect verification or partial testing should be performed, providing for the corresponding means and methods.
...
Exceeding these limits is likewise not permitted under any of the following deviations from normal operation (with due account of protective system action):
...
Such records should be attached to the materials of malfunction or accident investigations and retained with them throughout the entire operating period of the NPP.
...
\paragraph{4.1.2.}
The design limit of fuel element damage for normal operation, determining the allowable activity level of the primary-circuit coolant, shall be (Design Limit I for fuel element damage):
\begin{itemize}
...
\paragraph{4.1.3.}
In the event of primary circuit rupture, the emergency core cooling system shall ensure (Design Limit II for fuel element damage):
\begin{itemize}
...
\paragraph{4.2.3.}
In the event of primary circuit rupture, the emergency cooling system shall ensure (Design Limit II for fuel element damage):
\begin{itemize}
    \item fuel cladding temperature not exceeding \qty{1200}{\celsius};
    \item local oxidation depth of fuel cladding not exceeding \qty{18}{\percent} of initial wall thickness;
    \item fraction of reacted zirconium not exceeding \qty{1}{\percent} of the mass of cladding of the fuel rods belonging to one distribution group header (RGK).
\end{itemize}
...
\paragraph{5.17.}
\textbf{Safety Control Systems} -- systems intended to actuate safety systems and to monitor and control them during performance of their functions.
...
External influences include natural phenomena and human activities characteristic of the NPP site (earthquakes, high or low levels of surface water and groundwater, hurricanes, transport accidents, etc.).
...
\chapter*{Appendix F: Rules for Nuclear Safety of Atomic Power Plants (NSR-04-74)}
\addcontentsline{toc}{chapter}{Appendix F: Rules for Nuclear Safety of Atomic Power Plants (NSR-04-74)}
\markboth{Appendix F: Rules for Nuclear Safety of Atomic Power Plants (NSR-04-74)}{}

\begin{center}
\textbf{Rules for Nuclear Safety of Atomic Power Plants}\\
(\textit{ПБЯ-04-74})\\
Approved by Gosatomnadzor of the USSR\\
on 31 December 1974
\end{center}
...
\paragraph{2.15.} ``Maximum reactivity margin'' -- the reactivity realized in the reactor upon withdrawal of all CPS actuators, including solutions of liquid absorbers, at the campaign moment and reactor state with the maximum value of the effective multiplication coefficient ($k_{\text{eff}}$).
...
\paragraph{3.1.3.} Multi-purpose use of NPP systems and components is not permitted unless it is demonstrated that such combination of functions will not lead to violation of nuclear-safety conditions and requirements.
...
\emph{Recommendation.} It is desirable to have devices for analog display of the change in power, of reactivity, of the rate of change of reactivity, and of the positions in the reactor of CPS actuators.
...
\paragraph{3.2.2.} When designing the reactor, efforts should be made to ensure that the total power coefficient of reactivity is not positive under any operating modes of the NPP. If under any operating conditions the total power coefficient of reactivity is positive, the design shall ensure and explicitly substantiate nuclear safety of the reactor during steady-state, transient, and accident regimes.
...
\chapter*{Appendix G: Safety Justification of the First-Generation RBMK Reactor upon Completion of ``Measures\ldots'' of 27.06.86 at Unit~1 of the Chernobyl NPP}
\addcontentsline{toc}{chapter}{Appendix G: Safety Justification of the First-Generation RBMK Reactor}
\markboth{Appendix G: Safety Justification of the First-Generation RBMK Reactor}{}

\textit{Translator's note:} This document, reproduced in the original Russian edition within the body of Chapter~12, is the safety-justification report prepared for the restart of Unit~1 of the Chernobyl Nuclear Power Plant following the accident. It was signed in September~1986 by officials of the principal design and scientific organizations. The document is presented here in translation as a separate appendix for clarity.

\varthreestars

\begin{flushright}\small{
\textbf{Approved by:}\\
Chief Engineer of Enterprise P.O.~Box A-7631\\
V.~A.~Kurnosov \hfill 28.09.86\\[0.5\baselineskip]
\textbf{Approved by:}\\
Deputy Director of Enterprise P.O.~Box A-7291\\
Yu.~M.~Cherkashov \hfill 27.09.86\\[0.5\baselineskip]
\textbf{Approved by:}\\
Head of Department of Enterprise P.O.~Box A-1758\\
A.~K.~Kalugin \hfill 27.09.86\\[0.5\baselineskip]
\textbf{Approved by:}\\
Deputy Chief Engineer of the ``Hydroproject'' Institute\\
V.~A.~Zakharov \hfill 28.09.86
}\end{flushright}

\begin{center}
\textbf{SAFETY JUSTIFICATION OF THE FIRST-GENERATION RBMK REACTOR\\
UPON COMPLETION OF ``MEASURES\ldots'' OF 27.06.86\\
AT UNIT~1 OF THE CHERNOBYL NPP}\\[0.5\baselineskip]
Chernobyl, September 1986
\end{center}

\medskip

At Unit~1 of the Chernobyl Nuclear Power Plant, prior to the power startup, Stage~I of the ``Measures'' for improving the safety of RBMK reactors -- approved on 27.06.86 by the Ministry of Medium Machine Building, the Ministry of Energy, and agreed upon by Gosatomenergonadzor -- was carried out.

\begin{enumerate}
\item Thirty additional absorbers (DP) were loaded into the reactor; 124 fuel assemblies were replaced with fresh ones in order to increase the reactivity margin.

\item The upper limit switches of 78 rods were repositioned, ensuring immersion of the rods to a depth of \qty{1.2}{\metre} into the active zone.

\item An additional 11 manual-control (RR) rods were replaced with shortened absorber rods (USP). The travel of the USP rods was restricted to the interval $+1.2$ to $+\qty{3.5}{\metre}$.

\item Introduction of the USP rods into the active zone upon AZ-5 signals was implemented.

\item A cyclic calculation of the reactivity margin was set up on the station computer, with output to an indicating instrument and a chart recorder.

\item A panel for the automatic logging of the disengagement of emergency protections was assembled and placed in service.

\item A ``self-latch'' of the AZ-5 button was implemented.

\item The operating procedure (technological regulation) was revised and re-approved. The regulation now includes a complete list of emergency protections and the procedures for their engagement and disengagement during unit operation at various power levels and during shutdown. The reactivity margin under steady-state and transient operating regimes of the NPP is now strictly regulated.
\end{enumerate}

The effectiveness of the first two measures, which directly affect the nuclear safety of the reactor under accident conditions, was evaluated during the physical experiments preceding the power startup of Unit~1.

In the course of these experiments, the voiding effect of an RBMK-type reactor with a depleted core was measured for the first time; this became feasible after a four-month standstill of the unit. Measurements were conducted both before and after the fuel reloading of the active zone.

During the physical experiments, in order to obtain quantitative values of reactivity effects, 12 reactor startups to a power of \qty{30}{\kilo\watt} were performed under various conditions of the active zone, the main circulation loop, and the Control and Protection System loop. Reactor subcriticality monitoring and control were carried out using a specially developed CPS system employing in-core chambers KNK-56 and fission chambers KNT-31, as well as thermometric monitoring of fuel-assembly heating by means of thermocouples installed directly in the fuel assemblies. The informativeness of the measurements was substantially improved by determining the volumetric energy-release fields using the neutron activation method with copper indicators in the critical state of the reactor.

The following results were obtained:

\begin{enumerate}
\item The voiding effect of the cold reactor after fuel reloading was reduced by \qty{1.1}{\betaeff} and now amounts to \qty{2.9}{\betaeff}.

\item The calculated estimate of the reduction of the voiding effect by \qty{1}{\betaeff} upon an increase of the reactivity margin by 20~rods, and by \qty{0.6}{\betaeff} upon installation of 30 additional absorbers (DP), was confirmed.

\item Measurement of the rate of negative-reactivity insertion upon the drop of all rods extracted in the critical state (excluding the AZ rods) showed that, after repositioning the 78 upper limit switches, this rate is no less than \qty{0.6}{\betaeff\per\second} in the absence of partially immersed rods.

Taking into account the partially immersed manual-control (RR) rods providing a reactivity margin of 45~rods, the rate of negative-reactivity insertion upon AZ-5 actuation is \qty{1}{\betaeff\per\second}.

\item In none of the 12 rod-drop events from the upper limit switches during reactor shutdown (total number of rods dropped ranging from 26 to 114) was there any positive reactivity excursion.
\end{enumerate}

Assuming that the voiding effect is proportional to coolant density, we obtain that in the hot state with a reactivity margin of 45~rods the voiding effect (density change from \qty{0.78}{\gram\per\centi\metre\cubed} to zero) amounts to \qty{2.8}{\betaeff}, while the voiding effect at power (density change from \qty{0.5}{\gram\per\centi\metre\cubed} to zero) amounts to \qty{1.8}{\betaeff}.

The above estimates are maximal.

In the latter case, even under beyond-design-basis accident conditions for the first stage of the Chernobyl NPP (rupture of the MCP pressure header of \qty{1000}{\milli\metre} diameter), the voiding of the active zone -- occurring over a period measured in several seconds -- causes an increase in positive reactivity at a rate not exceeding \qty{0.9}{\betaeff\per\second}, which is compensated by the insertion of negative reactivity upon AZ actuation.

In the event of such an accident at low power, when the positive reactivity released equals \qty{2.8}{\betaeff}, the rate of voiding decreases because of the increase in coolant mass within the active zone. The rate of this process during the first seconds does not exceed \qty{0.5}{\betaeff\per\second} and thereafter drops sharply.

Thus, during voiding of the active zone arising from a rupture of large-diameter pipelines, reliable shutdown of the reactor is ensured.

Pending the implementation of the reconstruction measures for the first-generation NPPs with RBMK-1000 reactors recommended by the MVTS decisions of 1984 (installation of check valves in all distribution group headers, modernization of the emergency cooling system, etc.), the maximum design-basis accident for the first stage of the Chernobyl NPP is taken to be a rupture of the downcomer pipeline of \qty{300}{\milli\metre} diameter. Under such an accident, reactor shutdown and cooling of the active zone by the emergency cooling system, the feedwater pumps, and the emergency feedwater pumps are ensured.

Thus, the safety of first-generation RBMK reactors is improved upon completion of Stage~I of the ``Measures\ldots''.

The effectiveness of this stage will be definitively evaluated after conducting analogous experiments at Unit~2 of the Chernobyl NPP, measuring the dynamic characteristics of the reactors of Units~1 and~2 at a power level of 50--70\,\% of rated power, and thoroughly analyzing the experimental results.

Safety assurance must also be guaranteed by strict organizational measures to enforce adherence to the operating procedure and to strengthen production and technological discipline.

The transition to fuel with 2.4\,\% enrichment, scheduled from 1987, will further enhance the safety of RBMK reactors.

\medskip

\noindent\textit{From Enterprise P.O.~Box A-1758:} \hfill \textit{From Enterprise P.O.~Box A-7291:}\\
N.~N.~Kuzmin \hfill L.~V.~Reshetin\\
V.~P.~Kevrolev \hfill A.~P.~Sirotkin\\
\null\hfill V.~P.~Vasilevsky\\
\null\hfill S.~G.~Ukharov
...
\small\begin{center}
  \begin{longtable}{|p{6em}|p{27em}|}
    ...
    \hline
    01:06 a.m. & Start of unloading of the power unit; ORM equal to \num{31} control rods (RR). \\ \hline
    ...
    07:10 a.m. & ORM equal to \num{13.2} RR rods. \\ \hline
    01:05 p.m. & Turbogenerator-7 disconnected from the grid. \\ \hline
    02:00 p.m. & ECCS disconnected from CMPC. \\ \hline
    02:00 p.m. & Postponement of test programme execution at the request of the dispatcher of Kievenergo. \\ \hline
    03:20 p.m. & ORM equal to \num{16.8} RR rods. \\ \hline
    ...
    11:10 p.m. & Power-unit unloading resumed; ORM equal to \num{26} RR rods. \\ \hline
    ...
    00:36:24 a.m. & AZ setpoint for drop in pressure in the steam-drum separators shifted from \num{55} to \qty{50}{kgf\per\centi\metre\squared}.\\ \hline
    ...
    00:39:32 a.m. until 00:43:35 a.m. & Personnel blocked the AZ signal for shutdown of two turbines. \\ \hline
    ...
    01:22:30 a.m. & Parameters recorded to magnetic tape. (Post-accident calculation at Smolensk Nuclear Power Plant: ORM per PRISMA programme was 8 RR rods.)\\ \hline
...
\textit{Translator's note:} This article, here enclosed as an appendix, is dated 20~April~1991 and was published in the newspaper \textit{Komsomolskoye~Znamya} as an interview with A. S. Dyatlov, conducted by A.~Budnitsky and V.~Smaga. 
...
\textbf{--- We understand your desire to cast light upon the true causes of the catastrophe; yet tell us something further. The reactor lies in ruins; radioactive contamination advances. What, in your view, is the personal responsibility of the station's officials for the irradiation of the populace? In particular -- of the director, Viktor Petrovich Bryukhanov?}

\noindent
--- It is not easy for me to pass judgment upon others. I deem Bryukhanov culpable in that, on the very first day, he transmitted to Kiev a radiological report whose data were palpably understated. Yet I doubt that this report materially influenced subsequent decisions. Measurements continued uninterrupted, and the authorities were obliged to act according to them. Bryukhanov, moreover, bore responsibility only for the civil defence of the station, not of the city. Decisions concerning Pripyat ought to have been taken by the head of its civil defence, Vladimir Pavlovich Voloshko, chairman of the city executive committee. One may indeed argue that at that moment Bryukhanov should have -- to speak crudely -- struck his fist upon the table and demanded evacuation.
...
\textit{Translator's note:} This article, here enclosed as an appendix, has been originally published in the \textit{Vecherniy Kiev} newspaper. June 22, 1992, No. 120 (14484).
...
Let me be plain. I write these lines not to summon the aforementioned scientists before a tribunal, but to see justice prevail. A direct participant in the events of Chernobyl, Ukraine's Minister of Energy Vitaly Sklyarov, answered my inquiry concerning the personal responsibility of Aleksandrov and Dollezhal in these terms:

\begin{personal}[From V.~Sklyarov]
...
Head of CHPNP SAEN \hfill I. P. Aleksandrov \\
...
\small\begin{center}
  \begin{longtable}{|p{3em}|p{20em}|p{7em}|}
    ...
    \hline
    2.5. & Assemble the circuit for issuing the MPA signal to the electrical section of the stepped diesel-generator (DG) loading scheme and to the coast-down scheme on two sets of 4ShchANP-3 automation, as follows: on panel No.~2 (left side panel) of ChShch ANP-3, connect the contacts of the additionally installed button, routed to BSHU-4 (item PB-3), to terminals 10 (091-1) with 18 (09-1) and terminal 10 (01-1) with 36 (031-1), and also on panel No.~3 (left side panel) to terminals 10 (01-2) with 18 (09-2) and 10 (01-2) with 36 (031-2). & ETL \\
    \hline
    ...
    \hline
    2.13. & In the \qty{6}{\kilovolt} switchgear room and BSHU-4, assemble test circuits for oscillograph recording of parameters: stator voltage and current of TG-8; rotor voltage and current of TG-8; voltages and currents of input feeders of sections 8RA, 8RB, 8RNA; rotation speed of TG-8; currents and rpm of PN and GCN; moment of closure of stop valves. & DTE; SRZA; CTAI; ETL; CTAI \\
    \hline
...
\small\begin{center}
  \begin{longtable}{|p{3em}|p{20em}|p{7em}|}
    ...
    \hline
    3.6. & Remove seal 27N labeled ``Closure of stop valve TG-8 at disconnection of switch B2-6T or VTG-8'' from panel 24RG. & --- \\
    \hline
...
In this case, the excited generator will coast down together with the electric motors of sections 8RA and 8RB, supplying power to them and maintaining their electromagnetic torque (and consequently their productivity).
...
\small\begin{center}
  \begin{longtable}{|p{3em}|p{20em}|p{7em}|}
    ...
    \hline
    3.10.6 & Restore the position of gate valves closed per item 2.15. & RC-2; CHPNP \\
    \hline
    3.10.7 & Disconnect the 2DG-6 input and close sectional breakers 1VS-2VS of RIA at section 8RNA from panel PB-3 of BSHU-4, and necessary mechanisms. & NSB; NS of Electrical Shop \\
    \hline
...
\paragraph{5.2.2.} For serviceability of protective relay circuits of Block No. 4: Deputy Head of Electrical Shop, Malafienko S. A.

\paragraph{5.2.3.} For serviceability of MPA startup circuits and reliable power supply for Block No. 4: Deputy Head of Electrical Shop, Metelev V.I.

\paragraph{5.2.4.} For ensuring registration of technological parameters in tests: Deputy Head of Instrumentation and Automation, Lapuga N.R.

\paragraph{5.2.5.} For operative switching on auxiliary-system equipment of the Reactor Shop, Turbine Shop, and Central Technical Measurement and Instrumentation Department workshops: Shift Supervisors of respective shops.

\paragraph{5.2.6.} Overall direction during tests is exercised by Deputy Chief Engineer for Operations of the second stage, Dyatlov A. S.
...
\begin{enumerate}
  ...
  \item Printout of parameters via the DREG system is provided by SDIVT; responsible party: shift supervisor of CTAI.
\end{enumerate}
...
\begin{center}
  \textit{Translator's note: The contents of this chapter have been compiled by Anatoly Dyatlov's wife, Izabella, who has also published her husband's memoirs in the form of this book.}
\end{center}
...
I wish to note one important circumstance. Over the course of nearly fifty years of friendship -- \textit{``unto the last dregs of days'' -- }\footnote{An idiomatic expression meaning ``to the very end of life.''} I did not observe in Tolya a single dishonest act toward me, my relatives, or my acquaintances. I valued him for his straightforwardness, his purposefulness, his courage, his intellect, and his kindness toward people. By his entire life he confirmed these qualities.
...
(Luke~8{:}17)\footnote{The source text prints the citation as ``Luke 8-27''; the words quoted are in fact Luke~8{:}17, and the verse number is given here as corrected.}
\end{flushright}

The years 1953--59 were the years of our youth, of our student days. Tolya was older than most of us by some five years. Yet even then he seemed to us a man seasoned by life's experience. He was always an authority among us, and we loved him. He was the monitor of our group.
...
\textit{``For with what judgment ye judge, ye shall be judged: and with what measure ye mete, it shall be measured to you again.''}
(Matthew~7{:}2)
...
For the second time, our tragedy of 26~April~1986 drew me closer to A.~S.~Dyatlov. I wish, esteemed readers, to share with you how I came to know yet another facet of Anatoly Stepanovich's courageous character. Judge for yourselves: here is an excerpt from letters, beginning in 1989, written on behalf of the Kiev Council of the \textit{Society of Veterans of the Liquidation of the Accident and Its Consequences at the Chernobyl Nuclear Power Plant}, which were essentially unchanged in substance and were sent successively to the Supreme Court of the USSR, to the Chairman of the Supreme Soviet of the USSR, and finally to the President of the USSR, M.~S.~Gorbachev:

\begin{personal}[From the letter of the Kiev Council:]
...
On 27~October I was discharged home as a cripple, with bandages on wounds that trouble me to this day. On 31~December~1986 they took us to our home station and secretly handed out government awards: orders and medals -- to the living; orders posthumously -- to the widows. Could no place be found in Kiev, or were heroes awarded only there?! They found ``scapegoats'' -- they were tried. After several years they were released. And again -- silence?! How is one to look into the eyes of the children of the fallen?! For what -- or for whom -- did their fathers die?!
